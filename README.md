...
- Inside the php container make sure you run the laravel migrations ( inside /var/www directory! ) ```php artisan migrate``` ( ```php artisan migrate:install``` in case the previous did not work )
